...
class Actuators:
	...
	LED0, LED1, SPEAKER, NUM_ACTUATORS = range(4)
...
class Instructions:
	...
	NOP, LED0_ON, LED0_OFF, LED0_TOGGLE, LED1_ON, LED1_OFF, LED1_TOGGLE, SOUND_ON, SOUND_OFF, JUMP, LABEL, IF_MOTION, IF_N_MOTION, IF_SOUND, IF_N_SOUND, IF_TOUCH, IF_N_TOUCH, IF_CO2, IF_N_CO2, REPRODUCE, SEND_MESSAGE, MESS_TO_BUFF, DIS_TO_BUFF, BUFF_TO_DIS, NUM_INST = range(25)
